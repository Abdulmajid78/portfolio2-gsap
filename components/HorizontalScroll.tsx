...
const HorizontalScroll = () => {
        ...
        useEffect(() => {
                ...
                mm.add("(min-width: 1025px)", () => {
                    // All your desktop GSAP animations
                    gsap.to('.card-1', {
                        x: 380,
                        ease: 'none',
                        scrollTrigger: {
                    ...
                    <div ref={panelsRef} className="flex w-[500%] h-full">
                        ...
                        <AnimatedPanel className="panel bg-slate-500">
                            <div
                                ...
                                <div
                                    className="card card-1 max-w-lg bg-gradient-to-l from-neutral-500/90 to-slate-500 text-gray-200 rounded-xl px-4 py-6 xl:px-8 xl:py-8">
                        ...
                        <AnimatedPanel className="panel bg-blue-600">
                            <div
                                ...
                                <div
                                    className="card card-2 max-w-lg bg-gradient-to-l from-neutral-500/90 to-blue-600 text-gray-200 rounded-xl px-4 py-6 xl:px-8 xl:py-8">
                                    <div className="card-body">
                        ...
                        <AnimatedPanel className="panel bg-green-600">
                            <div
                                ...
                                <div
                                    className="card card-3 max-w-lg bg-gradient-to-l from-neutral-500/90 to-green-600 text-gray-200 rounded-xl px-4 py-6 xl:px-8 xl:py-8">
                                    <div className="card-body">
                        ...
                        <AnimatedPanel className="panel bg-yellow-600">
                            <div
                                ...
                                <div
                                    className="card card-4 max-w-lg bg-gradient-to-l from-neutral-500/90 to-yellow-600 text-gray-200 rounded-xl px-4 py-6 xl:px-8 xl:py-8">
                                    <div className="card-body">
