...
const projects: Project[] = [
    {
        ...
        description:
            "Landing Page: This site provides comprehensive information about the concept solution, including sections on About, Services, Clients, Partners, and Contact. After submitting the contact form, a representative will reach out to you. The site is available in three different languages.",
        technologies: ["React", "Tailwincss", 'i18n', "Responsive", "Axios"],
    ...
    },
    {
        ...
        description: "As an ice cream-focused website, we incorporated engaging animations and carousels to enhance the user experience. The site was developed with full backend integration, allowing products, categories, and other content to be dynamically managed from the backend.",
        technologies: ["React", "AOS animation", 'Carousel', "Axios"],
    ...
    },
    {
        id: 5,
        title: "Himplast Corp",
        description: "Unlike typical landing pages, this site retrieves buyer information directly from the backend. It is fully responsive and available in two languages.",
        technologies: ["React", "Tailwindcss", "Responsive", "axios", "Swagger"],
    ...
    },
    {
        ...
        description:
            "FreightGuardBusters.com is a specialized platform designed to support small and medium-sized trucking companies in removing unjust or inaccurate FreightGuard reports. By leveraging industry expertise and a user-friendly interface, the site enables carriers to initiate the process of disputing and potentially eliminating these reports",
        technologies: ["CSS", "ReactStrap", "Axios", "Material UI Skleton", "Responsive"],
    ...
    },
    {
        ...
        title: "Diyor Machine",
        description:
            "Although this site has not yet been deployed to the server, diyormachine.uz has been fully developed using Bootstrap for the frontend and Django models for the backend. Data is efficiently loaded into templates using Django's ORM, ensuring smooth integration between the interface and the database.",
        technologies: ["HTML", "CSS", "Django","Bootstrap 5", "DRF", "Responsive"],
    ...
    },
    {
        ...
        description:
            "The news section of the banking website, built with Next.js, features dynamic cards that regularly update by pulling news content from external sources, ensuring the site remains current and informative.",
        technologies: ["Next js", "CSS", "i18n", "Static", "Responsive"],
    ...
    },
    {
        id: 11,
        title: "Hayat Kabel",
        description: "HayatKabel.uz is a modern, mobile-responsive website where products and services are presented intuitively. It features a user-friendly interface and visually aligned design that reflects the brand.",
